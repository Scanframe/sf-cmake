...
if (NOT "${PACKAGE_FIND_VERSION}" STREQUAL "")
	...
	if ("${SF_GOOGLE_VERSION}" STREQUAL "")
		...
		if (NOT "${_Versions}" STREQUAL "")
			...
			set(SF_GOOGLE_VERSION "${PACKAGE_VERSION}" CACHE INTERNAL "Version of the framework from GitHub.")
		endif ()
	else ()
	endif ()
endif ()
...
if (NOT "${SF_GOOGLE_VERSION}" STREQUAL "")
	set(PACKAGE_VERSION "${SF_GOOGLE_VERSION}")
endif ()
