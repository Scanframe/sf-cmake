...
find_package(SfGoogleTest 1.17.0 CONFIG)
...
if (NOT "${PACKAGE_FIND_VERSION}" STREQUAL "")
	...
	if ("${SF_LIB_GOOGLETEST_VERSION}" STREQUAL "")
		# Get versions from GitHub through its API.
		Sf_GetGitHubVersions(_Versions "google" "googletest")
		...
		if (NOT "${_Versions}" STREQUAL "")
			...
			set(SF_LIB_GOOGLETEST_VERSION "${PACKAGE_VERSION}" CACHE INTERNAL "Version of the framework from GitHub.")
		endif ()
	else ()
		message(STATUS "Project '${PACKAGE_FIND_NAME}' packages using earlier set version ${SF_LIB_GOOGLETEST_VERSION}")
	endif ()
endif ()

# When a version is cached use it to set the package version from there.
if (NOT "${SF_LIB_GOOGLETEST_VERSION}" STREQUAL "")
	set(PACKAGE_VERSION "${SF_LIB_GOOGLETEST_VERSION}")
endif ()
