...
if (NOT "${PACKAGE_FIND_VERSION}" STREQUAL "")
	...
	if ("${SF_WIN_LAUNCH_VERSION}" STREQUAL "")
		# Get versions from GitHub through its API.
		Sf_GetGitHubVersions(_Versions "Scanframe" "win-launch")
		...
		if (NOT "${_Versions}" STREQUAL "")
			...
			set(SF_WIN_LAUNCH_VERSION "${PACKAGE_VERSION}" CACHE INTERNAL "Version of the framework from GitHub.")
		endif ()
	else ()
		message(STATUS "Project '${PACKAGE_FIND_NAME}' packages using earlier set version ${SF_WIN_LAUNCH_VERSION}")
	endif ()
endif ()

# When a version is cached use it to set the package version from there.
if (NOT "${SF_WIN_LAUNCH_VERSION}" STREQUAL "")
	set(PACKAGE_VERSION "${SF_WIN_LAUNCH_VERSION}")
endif ()
