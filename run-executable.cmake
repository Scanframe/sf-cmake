...
if (SF_VERBOSE)
	...
	message(STATUS "SF_EXEC_DIR_SUFFIX: ${SF_EXEC_DIR_SUFFIX}")
...
function(Sf_ArgsDecode _VarRef)
	set(_work_str "${${_VarRef}}")
	set(_result "")
	foreach (_entry IN LISTS _work_str)
		Sf_ArgDecode(_entry)
		string(APPEND _result "${_entry}" " ")
		#list(APPEND _result "${_entry}")
	endforeach ()
	string(STRIP "${_result}" _result)
	set(${_VarRef} "${_result}" PARENT_SCOPE)
endfunction()
