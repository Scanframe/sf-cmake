...
if (CPACK_GENERATOR IN_LIST SF_SUPPORTED_ARCHIVE_GENERATORS)
	...
	foreach (_Component IN LISTS CPACK_COMPONENTS_ALL)
		...
		set("CPACK_ARCHIVE_${_ComponentUpper}_FILE_NAME" "${SF_QT_PACKAGE_FILENAME_PREFIX}${_SubComponent}-${SF_TOOLCHAIN_STRING}_${SF_QT_VERSION}-${QT_TWEAK_VERSION}_${_Architecture}")
	endforeach ()
endif ()
